...
highlight(0, "VertSplit",               { fg = "##::background13::#", ctermfg = 8, bg = "none", ctermbg = "none" })
highlight(0, "WinSeparator",            { fg = "##::background13::#", ctermfg = 8, bg = "none", ctermbg = "none" })
highlight(0, "ToggleTerm1FloatBorder",  { fg = "##::background13::#", ctermfg = 8, bg = "none", ctermbg = "none" })
highlight(0, "TelescopeBorder",         { fg = "##::background13::#", ctermfg = 8, bg = "none", ctermbg = "none" })
