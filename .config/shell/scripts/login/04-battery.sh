...
for i in /sys/class/power_supply/BAT*; do
    ...
    # battery health
    printf "    Health: ${b_usecol}${b_wh_perc}.${b_wh_decperc}%%\033[39m (${b_wh_full}${b_wh_full_dec:+.$b_wh_full_dec}Wh/${b_wh_design}${b_wh_design_dec:+.$b_wh_design_dec}Wh)\033[22m;\033[1m\n"
